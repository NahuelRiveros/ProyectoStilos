...
function getImgSrc(img: CarritoItem["imagen"]): string | undefined {
...
export default function CartPage() {
  ...
  const [serverItems, setServerItems] = useState<CarritoItem[] | null>(null);
  ...
  async function handleCantidad(item: CarritoItem, delta: number) {
  ...
  async function handleRemove(item: CarritoItem) {
    if (isAuth && item.item_id) {
