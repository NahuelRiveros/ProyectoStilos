...
const DEFAULT_TIERS: PricingTier[] = [
  {
    ...
    price: "Gratis",
    description:
      "Acceso completo a nuestra tienda, historial de pedidos y atención básica.",
    features: [
      "Catálogo completo",
      "Carrito de compras",
  ...
  },
  {
    ...
    period: "/ mes",
    description:
      "La experiencia completa de Stilo's con beneficios exclusivos cada mes.",
    features: [
      "Todo lo de Estándar",
  ...
  },
  {
    ...
    period: "/ mes",
    description:
      "Membresía VIP con acceso a eventos exclusivos y servicio de personal shopper.",
    features: [
      "Todo lo de Premium",
      "20% de descuento permanente",
      "Envío express sin cargo",
...
export default function PricingSection({
  ...
  title = "Elegí tu plan",
  subtitle =
    "Beneficios pensados para que siempre estés a la moda sin complicaciones.",
  tiers = DEFAULT_TIERS,
}: PricingSectionProps) {
  return (
    <section className={UI_PRICING.section}>
        ...
        <div className={UI_PRICING.grid}>
          {tiers.map((tier) => {
            ...
            return (
              ...
              >
                {tier.badge && (
                  <span className={UI_PRICING.badge}>{tier.badge}</span>
                )}
                ...
                <div className={hl ? UI_PRICING.priceRowHighlighted : UI_PRICING.priceRow}>
                  ...
                  {tier.period && (
                    <span className={hl ? UI_PRICING.pricePeriodHighlighted : UI_PRICING.pricePeriod}>
                      {tier.period}
                    </span>
                  )}
                </div>
