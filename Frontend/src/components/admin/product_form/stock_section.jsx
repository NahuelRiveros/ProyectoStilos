...
function StockSection({
  ...
  return <div>
      {rows.length === 0 ? <p className="mb-3 text-xs text-muted">
          Sin talles — el producto tendrá stock general (sin desglose por talle).
        </p> : <div className="mb-3 space-y-2">
  ...
  >
      ...
      {totalStock > 0 && <p className="mt-3 text-xs text-emerald-600">
