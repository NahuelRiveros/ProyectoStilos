const UI_PRODUCT_CARD = {
  ...
  quickBtn: "flex h-9 w-9 items-center justify-center rounded-xl bg-card/90 text-ink shadow-sm backdrop-blur-sm transition hover:bg-card hover:text-navy",
  ...
  addToCart: "mt-3 w-full rounded-xl border border-navy bg-transparent py-2 text-xs font-semibold text-navy transition hover:bg-navy hover:text-white",
  // ── Horizontal card (listado / carrito) ───────────────────────
  horizontal: "flex overflow-hidden rounded-2xl border border-line bg-card",
