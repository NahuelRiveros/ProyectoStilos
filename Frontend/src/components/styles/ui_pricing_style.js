const UI_PRICING = {
  ...
  eyebrow: "mb-3 text-[10px] font-bold uppercase tracking-[0.22em] text-champagne",
  title: "font-display text-4xl font-bold tracking-tight text-ink sm:text-5xl",
  ...
  badge: "absolute -top-[13px] left-8 bg-champagne px-3 py-0.5 text-[9px] font-bold uppercase tracking-[0.18em] text-navy",
  tierName: "text-[10px] font-bold uppercase tracking-[0.22em] text-muted",
  tierNameHighlighted: "text-[10px] font-bold uppercase tracking-[0.22em] text-champagne/70",
  priceRow: "mt-6 flex items-end gap-1.5 border-b border-line pb-6",
  priceRowHighlighted: "mt-6 flex items-end gap-1.5 border-b border-white/10 pb-6",
  priceAmount: "font-display text-5xl font-bold tracking-tight text-ink",
  priceAmountHighlighted: "font-display text-5xl font-bold tracking-tight text-white",
  ...
  ctaHighlighted: "block w-full bg-champagne py-3 text-center text-xs font-bold uppercase tracking-[0.12em] text-navy transition-all duration-200 hover:bg-champagne-light"
};
export {
  UI_PRICING
};
