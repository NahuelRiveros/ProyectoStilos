const UI_CAROUSEL = {
  ...
  badge: "mb-5 w-fit border-b border-champagne/50 pb-1.5 text-[10px] font-bold uppercase tracking-[0.22em] text-champagne",
  title: "font-display text-5xl font-bold leading-[1.04] tracking-tight text-ink sm:text-6xl lg:text-7xl",
  ...
  imageFrame: "relative mx-auto aspect-[3/4] max-h-[500px] w-full max-w-[280px] overflow-hidden bg-champagne-light sm:max-w-xs lg:max-w-none",
  imageFrameAccent: "absolute -bottom-3 -right-3 aspect-[3/4] max-h-[500px] w-full border border-champagne/35 lg:max-w-none",
  image: "h-full w-full object-cover",
  imagePlaceholder: "flex h-full w-full items-center justify-center text-champagne/20",
  // Controls bar
  controlsOuter: "border-t border-line",
  controlsInner: "mx-auto flex max-w-7xl items-center justify-between px-4 py-3.5 sm:px-6 lg:px-8",
  ...
  arrowBtn: "flex h-8 w-8 items-center justify-center border border-line text-ink transition-colors hover:border-navy/40 hover:text-navy",
