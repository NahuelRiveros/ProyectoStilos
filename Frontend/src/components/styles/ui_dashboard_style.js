const UI_DASHBOARD = {
  ...
  content: "mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8",
  // ── Page header ───────────────────────────────────────────────
  pageHeader: "mb-8",
  ...
  sectionAction: "text-xs font-medium text-navy underline-offset-2 transition hover:text-navy-dark hover:underline",
  // ── Empty state ───────────────────────────────────────────────
  empty: "flex flex-col items-center justify-center rounded-2xl border border-dashed border-line bg-card py-16 text-center",
  emptyIcon: "mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-surface text-muted",
