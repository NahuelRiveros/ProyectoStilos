const UI_ANNOUNCEMENT = {
  ...
  dismissBtn: "absolute right-0 top-0 flex h-full w-10 items-center justify-center bg-gradient-to-l from-navy via-navy/90 to-transparent text-white/30 transition-colors hover:text-champagne"
};
export {
  UI_ANNOUNCEMENT
};
