const UI_BUTTONS = {
  ...
  variants: {
    primary: "bg-navy text-white shadow-sm hover:bg-navy-dark focus:ring-2 focus:ring-navy/20",
    secondary: "border border-line bg-card text-ink hover:bg-surface hover:text-ink focus:ring-2 focus:ring-navy/10",
    ...
    ghost: "bg-transparent text-ink hover:bg-surface hover:text-ink",
    link: "rounded-none bg-transparent px-0 text-ink underline-offset-4 hover:underline",
    outline: "border border-navy bg-transparent text-navy hover:bg-navy hover:text-white",
    accent: "bg-champagne text-navy shadow-sm hover:bg-champagne-light focus:ring-2 focus:ring-champagne/30"
  },
  disabledVariants: {
