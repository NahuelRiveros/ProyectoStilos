const UI_CONTAINER = {
  ...
  badge: "mb-3 inline-flex rounded-full border border-line bg-card px-3 py-1 text-xs font-semibold uppercase tracking-wide text-muted shadow-sm",
  title: "font-display text-3xl font-bold tracking-tight text-ink sm:text-4xl",
  accent: "text-champagne",
  subtitle: "mt-3 max-w-3xl text-sm font-medium leading-6 text-muted sm:text-base",
  ...
  panel: {
    card: "",
    glass: "rounded-3xl border border-card/70 bg-card/80 p-5 shadow-xl shadow-navy/5 backdrop-blur-xl sm:p-6",
    plain: "w-full"
  },
