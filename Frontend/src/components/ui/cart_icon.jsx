...
function CartIcon() {
  ...
  >
      <ShoppingBag size={20} />
      {cantidadItems > 0 && <span className="absolute -right-1 -top-1 flex h-4 min-w-4 items-center justify-center rounded-full bg-champagne px-0.5 text-[9px] font-black text-white">
